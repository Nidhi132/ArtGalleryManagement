...
<form ACTION="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" METHOD="POST">
  <div class="container">
    ...
    <label for="phone"><b>Phone</b></label><span class="error">* <?php echo $phone2Err;?></span><br>
    <input type="text" placeholder="Enter Phone No" name="PHONE2" required value="<?= $phone2; ?>"><br>
    </hr>
...
<p style="font-family: arial; float: right;"><a href="Logout.php"><font style="color:black">LogOut</font></a></p>
 ...
 <?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql3 = "INSERT INTO GCONTACTS(gid, phone2) VALUES('".$id."', '".$phone2."')";
