...
<body style="background-color: lavender">
 ...
 <tr>
  ...
  <?php
$con = mysqli_connect("127.0.0.1:3307", "root", "", "art_gallery");
  ...
  // $sql = "CREATE PROCEDURE GetAge() SELECT *, year(current_date())-year(dob) as AGE from CUSTOMER c, contacts cc where c.cid = cc.cid and c.cid='$id'"; 
