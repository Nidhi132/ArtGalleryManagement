...
<html>
<head>
    <title>Insert into Artwork</title>
</head>
...
<form ACTION="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" METHOD="POST" enctype="multipart/form-data">
  <div class="container">
    ...
    <label for="artid"><b>Artwork ID</b></label><span class="error">* <?php echo $artidErr;?></span><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql3 = "INSERT INTO artwork(artid, title, type, initialprice, aid, year, image) VALUES('".$artid."', '".$title."', '".$type."', '".$price."', '".$id."', '".$year."', '".$filename."')";
...
// } else {
    ...
    $sql = "INSERT into bid(artid, stat, aid, starttime, endtime) VALUES('".$artid."', '".$status."', '".$id."', '".$starttime."', '".$endtime."')";
