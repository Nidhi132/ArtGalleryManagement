...
if (empty($_POST["PW2"])) {
    $pw2Err = "Correct Password is required";
  } else {
    // $pw2 = $_POST['PW2'];
    //create our salt
    $salt = 'XyZzy12*_';
...
?>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        <div>Enter Gallery ID:<input type="text" name="GID" placeholder="GID" value="<?= $gid; ?>"><span class="error">* <?php echo $gidErr;?></span><br></div>
        <div>Enter PASSWORD:<input type="password" name="PW2" placeholder="PASSWORD"><span class="error">* <?php echo $pw2Err;?></span><br></div>
        <br><br>
...
<p style="font-family: arial; "><a href="gallery1.html"><font style="color:gold">GO BACK</font></a></p>
 ...
 <?php
 // session_start();
    // if(isset($_POST['GID']) && isset($_POST['PW2'])):
    ...
    $sql3 = "select * from gallery where gid='$gid'";
